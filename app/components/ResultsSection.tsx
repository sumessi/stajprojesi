...
export default function ResultsSection({ activeSearch, matchedUsers }: ResultsSectionProps) {
  ...
  return (
    <section className="relative pt-0 px-60 py-8">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {matchedUsers.map(([uid, ids]) => (
            <button
              ...
              className="bg-white/10 border border-white/20 rounded-xl p-6 text-white hover:bg-white/20 transition shadow-md"
            >
